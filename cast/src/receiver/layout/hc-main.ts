...
export class HcMain extends HassElement {
  ...
  private _getErrorMessage(error: number): string {
    switch (error) {
      case 1:
        return "Unable to connect to the Third Eye websocket API.";
      case 2:
        return "The supplied authentication is invalid.";
      case 3:
        return "The connection to Third Eye was lost.";
      case 4:
        return "Missing hassUrl. This is required.";
      case 5:
        return "Third Eye needs to be served over https:// to use with Third Eye Cast.";
      default:
