# Bundling Third Eye Frontend

The Third Eye build pipeline contains various steps to prepare a build.
...
Currently in Third Eye we use a bundler to convert TypeScript, CSS and JSON files to JavaScript files that the browser understands.
